package
{
	...
	public class InstructionsPageTwo extends FlxState
	{
		...
		[Embed(source = "data/instructions2.png")] public var instructions2Png:Class;
		...
		override public function create():void
		{
			...
			instructions = new FlxSprite(0, 0, instructions2Png);
			add(instructions);
			
			text = new FlxText(0, 170, FlxG.width, "X: Pick Up/Place\n   Block Columns\n\n\n\nPress ENTER to continue");
		...
		override public function update():void
		{
			...
			{
				FlxG.switchState(new InstructionsPageThree());
			}
		...
		public function InstructionsPageTwo()
		{
			super();
